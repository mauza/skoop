...
import (
	...
	"github.com/mauza/skoop/server/config"
	"github.com/mauza/skoop/server/handlers"
	"github.com/mauza/skoop/server/storage"
	"github.com/mauza/skoop/server/storage/postgres"
...
var serveCmd = &cobra.Command{
	Use:   "serve",
	Short: "Start and serve the skoop api",
...
func registerServices() {
	var apiServer skoopv1.ApiServer = &handlers.ApiServer{}
	skoopv1.RegisterApiServer(Server.Server, apiServer)
}
...
func runGateway() {
	...
	err := skoopv1.RegisterApiHandlerFromEndpoint(context.Background(), mux, grpcAddress, opts)
